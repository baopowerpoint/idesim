...
function SkeletionWithCard() {
  return (
    <div
      role="status"
      className="p-4 max-w-[300px] w-full mt-5 rounded-lg  border border-gray-700 shadow animate-pulse md:p-6 "
    >
...
export default SkeletionWithCard;
